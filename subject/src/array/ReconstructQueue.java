...
public class ReconstructQueue {
     ...
     * 里面的人，所以从B中选出一个人p，则其位置只会和B有关，不会受其后面人（A）的影响，所以其位于A中的位置便可以确定下来
     * 即p[1]代表的就是插入B中的位置（表示其前面有多少个人存在），这里容易忽视的一点是，若B中存在于当前p一样高的情况下，
     * 如果随意加入，可能会影响前面已加入的哪一个人的位置，所以为了避免这种情况，可以在排序时将p[1]小的排在前面，这样就
     * 不会受后面同样高的人的影响了（因为后来的的p始终插在其后面）
     * <p>
